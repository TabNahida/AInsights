...
class DocsMarkupTests(unittest.TestCase):
    ...
    def test_methodology_page_is_linked_from_ranking_not_navigation(self):
        ...
        self.assertIn("Benchmarks and Weights", html)
        ...
        self.assertIn("<td>14%</td>", html)
        self.assertIn("<td>16%</td>", html)
        self.assertIn("Hallucination Rate is excluded from AIndex", html)
        self.assertLess(html.index("Benchmarks and Weights"), html.index("AIndex Calculation"))
