...
class DocsMarkupTests(unittest.TestCase):
    ...
    def test_methodology_page_is_linked_from_ranking_not_navigation(self):
        ...
        self.assertIn("Regular Tests and Bonus Tests", html)
        ...
        self.assertIn("coverage discount", html)
        self.assertIn("available regular-weight coverage", html)
        self.assertIn("Regular coding", html)
        self.assertIn("Regular hard reasoning", html)
        self.assertIn("hard reasoning", html)
        self.assertIn("Regular instruction/context", html)
        self.assertIn("Bonus hard external tests", html)
        self.assertIn("SWE-Bench", html)
        self.assertIn("FrontierMath", html)
        self.assertIn("Terminal-Bench v2.1", html)
        self.assertIn("<td>76</td>", html)
        self.assertIn("<td>23</td>", html)
        self.assertIn("<td>1</td>", html)
        self.assertIn("<td>+2 max</td>", html)
        self.assertIn("log1p(5x) / log(6)", html)
        self.assertIn("Terminal-Bench Hard, SciCode, Humanity's Last Exam, and CritPt use this calibrated curve", html)
        self.assertIn("LiveCodeBench is a high-weight regular coding signal", html)
        self.assertIn("External benchmark:livecodebench scores can fill missing regular LiveCodeBench values", html)
        self.assertIn("shared across variants of the same model", html)
        self.assertIn("not default bonus rows", html)
        self.assertLess(html.index("Regular Tests and Bonus Tests"), html.index("AIndex Calculation"))
