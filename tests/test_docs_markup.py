...
class DocsMarkupTests(unittest.TestCase):
    ...
    def test_methodology_page_is_linked_from_ranking_not_navigation(self):
        ...
        self.assertIn("Frontier Groups and Weights", html)
        ...
        self.assertIn("within-group evidence coverage", html)
        self.assertIn("AA suite", html)
        self.assertIn("Agentic coding", html)
        self.assertIn("Tools/work", html)
        self.assertIn("Reasoning", html)
        self.assertIn("Instruction/long-context", html)
        ...
        self.assertIn("<td>3.3%</td>", html)
        self.assertIn("<td>2.5%</td>", html)
        self.assertIn("<td>0.8%</td>", html)
        self.assertIn("shared across variants of the same model", html)
        self.assertIn("Hallucination Rate is excluded from the AA suite anchor", html)
        self.assertLess(html.index("Frontier Groups and Weights"), html.index("AIndex Calculation"))
