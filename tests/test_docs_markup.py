...
class DocsMarkupTests(unittest.TestCase):
    ...
    def test_methodology_page_is_linked_from_ranking_not_navigation(self):
        ...
        self.assertIn("within-board coverage discount exponent is 0.03", html)
        self.assertIn("single-metric board exponent is 0.12", html)
        self.assertIn("AIndex = 100 *", html)
        ...
        self.assertIn("benchmark:swe-bench-pro", html)
        self.assertIn("benchmark:aime-2026", html)
        self.assertIn("benchmark:mmlu-pro", html)
        self.assertIn("benchmark:charxiv-no-tools", html)
        ...
        self.assertIn("external benchmark:livecodebench", html)
